...
# touch results/minimax_alphabeta_move_time_5.txt
# touch results/alphabeta_minimax_move_time_5.txt
# touch results/minimax_alphabeta_move_time_10.txt
# touch results/alphabeta_minimax_move_time_10.txt
# touch results/light_heavy.txt
# touch results/heavy_light.txt
touch results/compete_compete_game_time_100.txt
touch results/compete_compete_game_time_200.txt
touch results/compete_compete_game_time_500.txt
touch results/global_global_game_time_100.txt
touch results/global_global_game_time_200.txt
touch results/global_global_game_time_500.txt
touch results/minimax_simple_move_time_15.txt
touch results/simple_minimax_move_time_15.txt
touch results/alphabeta_simple_move_time_15.txt
touch results/simple_alphabeta_move_time_15.txt
#
